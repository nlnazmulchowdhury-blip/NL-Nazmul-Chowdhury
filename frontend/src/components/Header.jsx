        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2.5 group">
            ...
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-xs font-semibold text-indigo-500 bg-indigo-50 px-1.5 py-0.5 rounded-md">BD</span>
            </div>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            <Link to="/tools" className="ml-2 btn-primary !py-2 !px-5 text-sm flex items-center gap-1.5">
              Get Started
              <ArrowRight size={16} />
            </Link>
          </nav>
